...
import '../../../../components/bidan/tumbuh_kembang/perkembangan_anak/bidan_detail_perkembangan_anak_modal.dart';
import '../../../../components/bidan/tumbuh_kembang/perkembangan_anak/bidan_perkembangan_anak_card.dart';
import '../../../../components/bidan/tumbuh_kembang/perkembangan_anak/bidan_tambah_perkembangan_anak_modal.dart';
import '../../../../components/bidan/tumbuh_kembang/perkembangan_anak/filter_perkembangan_anak_modal.dart';
import '../../../../components/bidan/tumbuh_kembang/perkembangan_anak/ubah_perkembangan_anak_modal.dart';
...
class BidanPerkembanganAnakScreen extends StatelessWidget {
  const BidanPerkembanganAnakScreen({Key? key}) : super(key: key);
                ...
                child: CustomElevatedButtonIcon(
                  ...
                  onPressed: () {
                    showDialog(
                        context: context,
                        builder: (_) =>
                            const BidanTambahPerkembanganAnakModal());
                  },
                ),
              ),
              Padding(
                ...
                child: CustomElevatedButtonIcon(
                  ...
                  onPressed: () {
                    showDialog(
                        context: context,
                        builder: (_) => const FilterPerkembanganAnakModal());
                  },
                ),
              ),
              Padding(
  ...
  Widget generateData(BuildContext context) {
    return Column(children: [
      BidanPerkembanganAnakCard(
        ...
        onTap: () => showDialog(
            context: context,
            builder: (_) => const BidanDetailPerkembanganAnakModal()),
        onEdit: () => showDialog(
            context: context,
