...
class DeteksiStuntingCard extends StatelessWidget {
  DeteksiStuntingCard({
    Key? key,
  }) : super(key: key);
  ...
  final String cardTitle = "DETEKSI STUNTING";
  final Widget img = SvgPicture.asset("assets/images/deteksi_stunting.svg");
