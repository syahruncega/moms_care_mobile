...
import 'package:moms_care_mobile/components/bidan/moms_care/deteksi_dini/ubah_deteksi_dini_modal.dart';
...
class BidanDetailDeteksiDiniModal extends StatelessWidget {
  const BidanDetailDeteksiDiniModal({Key? key}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: CustomElevatedButtonIcon(
                      ...
                      onPressed: () {
                        ...
                        showDialog(
                            context: context,
                            builder: (_) => UbahDeteksiDiniModal());
                      },
                    ),
                  ),
                ],
