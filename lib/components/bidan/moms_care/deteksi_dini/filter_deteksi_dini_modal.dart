...
class FilterDeteksiDiniModal extends StatelessWidget {
  const FilterDeteksiDiniModal({Key? key}) : super(key: key);
                  ...
                  child: Column(children: <Widget>[
                    ...
                    CustomAutocompletedTextField(
                      ...
                      items: const [
                        {'label': 'Semua', 'value': 'semua'},
                        {
                          'label': 'Kehamilan : KRR (Berisiko Rendah)',
                          'value': 'krr'
                        },
                        {
                          'label': 'Kehamilan : KRT (Berisiko Tinggi)',
                          'value': 'krt'
                        },
                        {
                          'label': 'Kehamilan : KRST (Berisiko SANGAT TINGGI)',
                          'value': 'krst'
                        },
                      ],
                      onSuggestionSelected: (value) => value,
