...
class FilterIbuStuntingModal extends StatelessWidget {
  const FilterIbuStuntingModal({Key? key}) : super(key: key);
            ...
            child: Column(children: <Widget>[
              Row(
                ...
                children: const <Widget>[
                  Flexible(
                    child: Text(
                      'Filter Data Ibu Melahirkan Stunting',
                      style: TextStyle(
                  ...
                  child: Column(children: <Widget>[
                    ...
                    CustomAutocompletedTextField(
                      ...
                      items: const [
                        {'label': 'Semua', 'value': 'semua'},
                        {
                          'label': 'Berisiko Melahirkan Stunting',
                          'value': 'berisiko_melahirkan_stunting'
                        },
                        {
                          'label': 'Tidak Berisiko Melahirkan Stunting',
                          'value': 'tidak_berisiko_melahirkan_stunting'
                        },
                      ],
                      onSuggestionSelected: (value) => value,
                    ),
