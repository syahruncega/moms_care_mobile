...
class BidanDetailPernikahanDiniModal extends StatelessWidget {
  const BidanDetailPernikahanDiniModal({Key? key}) : super(key: key);
            ...
            child: Column(children: <Widget>[
              Row(
                children: const <Widget>[
                  Flexible(
                    child: Text(
                      'Hasil Mencegah Pernikahan Dini',
                      style: TextStyle(
                ...
                children: [
                  ...
                  DottedBorder(
                    ...
                    child: Padding(
                      ...
                      child: CustomRadioInput(
                        title:
                            "3. Jika anda perempuan, apakah anda berencana menikah di usia 35 tahun ? (Jawab Tidak bila anda laki-laki)",
                        option: [
                          Flexible(
                            child: RadioListTile(
                              title: const Text(
                  ...
                  Padding(
                    ...
                    child: CustomElevatedButtonIcon(
                        ...
                        onPressed: () {
                          ...
                          showDialog(
                              context: context,
                              builder: (_) => const UbahPernikahanDiniModal());
                        }),
                  ),
                ],
              )
