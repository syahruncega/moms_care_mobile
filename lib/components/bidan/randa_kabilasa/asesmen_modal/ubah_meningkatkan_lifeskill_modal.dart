...
class UbahLifeSkillModal extends StatelessWidget {
  const UbahLifeSkillModal({Key? key}) : super(key: key);
            ...
            child: Column(children: <Widget>[
              Row(
                ...
                children: const <Widget>[
                  Flexible(
                    child: Text(
                      'Ubah Meningkatkan Life Skill dan Potensi Diri',
                      style: TextStyle(
                      ...
                      children: [
                        ...
                        DottedBorder(
                          ...
                          child: Padding(
                            ...
                            child: CustomRadioInput(
                              title:
                                  "3. Apakah Anda Saat ini aktif berkegiatan Extrakurikuler disekolah atau di perguruan tinggi ?",
                              option: [
                                Flexible(
                                  child: RadioListTile(
                                    title: const Text(
