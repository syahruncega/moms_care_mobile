...
List<Bidan> listBidanFromJson(String str) => List<Bidan>.from(json.decode(str).map((x) => Bidan.fromJson(x)));

String listBidanToJson(List<Bidan> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
