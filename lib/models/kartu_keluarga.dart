...
List<KartuKeluarga> listKartuKeluargaFromJson(String str) => List<KartuKeluarga>.from(json.decode(str).map((x) => KartuKeluarga.fromJson(x)));

String listKartuKeluargaToJson(List<KartuKeluarga> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
