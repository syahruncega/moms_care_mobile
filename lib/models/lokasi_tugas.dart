...
LokasiTugas listLokasiTugasFromJson(String str) =>
    LokasiTugas.fromJson(json.decode(str));
...
class LokasiTugas with _$LokasiTugas {
  ...
  factory LokasiTugas.fromJson(Map<String, dynamic> json) =>
      _$LokasiTugasFromJson(json);
}
