...
List<KabupatenKota> listKabupatenKotaFromJson(String str) =>
    List<KabupatenKota>.from(
        json.decode(str).map((x) => KabupatenKota.fromJson(x)));

String listKabupatenKotaToJson(List<KabupatenKota> data) =>
